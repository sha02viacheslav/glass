        ...
        <div id="footer-main">
                ...
                <div className="container">
                    ...
                    <p className="mb-0 slider-content">
                        ...
                        <span className="d-lg-block">
                            {" "}
                            what was the car brand and the model.
                        </span>
                    </p>
                    ...
                    <Slider {...settingsTestimonials}>
                        ...
                        <div className="item ">
                            <div className="testmon-box mb-4">
                                <div className="d-flex justify-content-between">
                                    <div className="avator">
                                        <p className="mb-0 text-purple">
                                            <img
                                                src={process.env.PUBLIC_URL +"/img/avator.png"}
                                ...
                                <p className="fs-12">
                                    Amet minim mollit non deserunt ullamco est sit est aliqua
                                    dolor do amet sint. Velit officia consequat e duis enim velit
                                    mollit. Exercitation veniam onequat sunt nostrud amet 👍 🎯{" "}
                                </p>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-md-9 col-lg-7">
                            <div className="row d-lg-none d-md-none d-flex">
                                <div className="col-7">
                                    <h2 className="title-s mb-4 pt-md-0 pt-5">
                                        ...
                                        <span className="text-purple d-md-block">
                                            {" "}
                                            we plant a tree.
                                        </span>{" "}
                                    </h2>
                            ...
                            <p className="text-blue pe-md-5">
                                As the biggest plants on the planet, they give us oxygen, store
                                carbon, stabilize the soil and give life to the world’s
                                wildlife. Trees regulate the water cycle.
                            </p>
                            <div className="row">
                                <div className="col-md-12 col-lg-9">
                                    <div className="position-relative pt-md-4">
                                        <img
                                            src={process.env.PUBLIC_URL +"/img/re-cycle.png"}
                                            className="img-fluid m-hmob"
                                            alt=""
                                        />
                                        ...
                                        <div className="recycle-content">
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <div className="re-img mt-auto">
                                                    <img
                                                        src={process.env.PUBLIC_URL +"/img/re-cyc.png"}
                                                        className="img-fluid"
                                                        alt=""
                                                    />
                                                </div>
            ...
            <footer className="footer">
                            ...
                            <div className="row">
                                <div className="col-lg-6 offset-lg-6">
                                    <h3 className="text-white mb-4">
                                        Lorem ipsum dolor sit amet adicipling elit ullamco euismod
                                    </h3>
                                    <div className="row">
                            ...
                            <div className="row">
                                <div className="col-md-2">
                                    <div className="f-logo mt-0">
                                        <a href="#">
                                            <img
                                                src={process.env.PUBLIC_URL +"/img/f-logo.png"}
                                                className="img-fluid"
                                                width="120"
                                                alt=""
                                            />
                                ...
                                <div className="col-md-5">
                                    ...
                                    <p className="text-white mb-0">
                                        Wherever you are, whichever model you drive, we got you
                                        covered. We offer nationwide windscreen repairs and
                                        replacements for passenger vehicles and vans. All jobs are
                                        done by professionals at your home or work.
                                    </p>
                                </div>
                ...
                <section className="footer-btm py-3">
                    <div className="container">
                        <p className="mb-0">
                            Copyright by © Est Glass. All rights reserved.
                        </p>
                    </div>
                </section>
            </footer>
