...
const vehTypes = [
    ...
    ["CONVERTIBLE", "COUPE"],
    ["AMBULANCE", "BOX VAN", "CAR TRANSPORTER", "CHASSIS CAB", "CHASSIS COWL", "INSULATED CAN", "LUTON VAN", "MINIBUS", "MOTOR CARAVAN", "PANEL VAN", "PICK UP", "SPECIALLY FITTED VAN", "TIPPER", "WINDOW VAN", "LCV"]
]
