                            ...
                            <div className='PM-single-pay'>
                                ...
                                >
                                    <div className="position-relative w-100">
                                        <svg className="p-Icon p-Icon--card Icon p-Icon--md p-TabIcon TabIcon" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                ...
                                >
                                    <div className="position-relative w-100">
                                        <div className="p-TabIconContainer">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="p-Logo p-Logo--md p-TabIcon TabIcon">
