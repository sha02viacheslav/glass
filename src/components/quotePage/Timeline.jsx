          ...
          <Stepper activeStep={activeStep} alternativeLabel>
            {steps.map((element) => (
              ...
              >
                ...
                {element === 'Job started' && !imgUploaded && (
                  <div className='center-content cam-icon-frame'>
            ...
            <Stepper activeStep={activeStep} orientation='vertical'>
              {steps.map((element) => (
                ...
                >
                  <StepLabel>{element}</StepLabel>
                  <StepContent>
                    {element === 'ETA' && <Typography></Typography>}
                    {element === 'Job started' && imgUploaded && <img className='window-image' src={before} alt='' />}
                    {element === 'Job started' && !imgUploaded && (
                      <div className='center-content cam-icon-frame'>
                        <img className='img-upload' src={cameraIcon} alt='' />
                      </div>
                    )}
                    {element === 'Finished' && imgUploaded && <img className='window-image' src={after} alt='' />}
                    {element === 'Finished' && !imgUploaded && (
                      <div className='center-content cam-icon-frame'>
                        <img className='img-upload' src={cameraIcon} alt='' />
                      </div>
