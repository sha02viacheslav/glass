    ...
    return (
        <div>
            <section className="map">
                <div id="map-container-google-1" className="z-depth-1-half map-container position-relative" width="100%" style={{ height: 400 + 'px' }}>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8">
                            ...
                            <p className="main-content mt-3 mb-4">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit offici liqua conti.</p>
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <p className="mb-0"> <a href="#" className="text-gray text-decoration-none">+44 772 345 1616</a></p>
                                    <a href="#" className="text-gray text-decoration-none">contact@estglass.co.uk</a>
                                </div>
                            </div>
                        </div>
