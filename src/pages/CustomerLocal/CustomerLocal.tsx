                      ...
                      <div className='code-state me-5'>
                        <ul className='list-inline d-flex align-items-center'>
                          <li className='list-inline-item state-bg'>
                            ...
                            >
                              <g clipPath='url(#clip0_870_5075)'>
                                <path d='M0 0H10V7H0V0Z' fill='#012169' />
                                <path
                                  d='M1.17188 0L4.98438 2.63958L8.78125 0H10V0.904167L6.25 3.51458L10 6.11042V7H8.75L5 4.38958L1.26562 7H0V6.125L3.73438 3.52917L0 0.933333V0H1.17188Z'
                                  fill='white'
                                />
                                <path
                                  d='M6.625 4.09792L10 6.41667V7L5.76562 4.09792H6.625ZM3.75 4.38958L3.84375 4.9L0.84375 7H0L3.75 4.38958ZM10 0V0.04375L6.10938 2.78542L6.14062 2.14375L9.21875 0H10ZM0 0L3.73438 2.56667H2.79688L0 0.6125V0Z'
                                  fill='#C8102E'
                                />
                                <path
                                  d='M3.76562 0V7H6.26562V0H3.76562ZM0 2.33333V4.66667H10V2.33333H0Z'
                                  fill='white'
                                />
                                <path
                                  d='M0 2.81458V4.21458H10V2.81458H0ZM4.26562 0V7H5.76562V0H4.26562Z'
                                  fill='#C8102E'
                                />
                              </g>
                              <defs>
                ...
                <div className='row mt-4 mt-md-5 text-center'>
                  <div className='col-md-9 mx-auto'>
                    ...
                    <div className='btns my-4'>
                      ...
                      <a href='#' className='btn btn-gray'>
                        Rear Door Quarter SX
                      </a>
                      <a href='#' className='btn btn-gray'>
                        Front Door Quarter RX
                      </a>
                      <a href='#' className='btn btn-gray'>
                        Front Door Quarter SX
                      </a>
                      <a href='#' className='btn btn-gray'>
                        Rear Door RX
                      </a>
                  ...
                  <div className='col-md-8 mx-auto'>
                      ...
                      <ul className='nav nav-pills  mb-3 justify-content-center mb-4' id='pills-tab' role='tablist'>
                        <li className='nav-item' role='presentation'>
                          <button
                            ...
                            id='pills-oem-tab'
                            data-bs-toggle='pill'
                            data-bs-target='#pills-oem'
                            type='button'
                            role='tab'
                            aria-controls='pills-oem'
                            aria-selected='true'
                          >
                            OEM Original Part
                          </button>
                        ...
                        <li className='nav-item' role='presentation'>
                          <button
                            ...
                            id='pills-arg-tab'
                            data-bs-toggle='pill'
                            data-bs-target='#pills-arg'
                            type='button'
                            role='tab'
                            aria-controls='pills-arg'
                            aria-selected='false'
                          >
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className='text-center'>
                                    <a className='btn btn-mini'>Green tint</a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>Rain Sensor </th>
                                  <td className='text-center'>
                                    <a className='btn btn-mini'>Yes</a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>Heating </th>
                                  <td className='text-center'>
                                    <a className='btn btn-mini-gray'>No</a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>Quality </th>
                                  <td className='text-center'>
                                    <a className='btn btn-mini'>High</a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>
                                ...
                                <tr>
                                  <th className='border-bottom-0'>TOTAL PRICE</th>
                                  <td className='border-bottom-0'>
                                    <p className='mb-0 text-purple fs-18 fw-500'>£410</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <table className='table table-striped'>
                              <tbody>
                                <tr>
                                  ...
                                  <td className='text-center'>
                                    <a className='btn btn-mini-gray disabled'>Green tint</a>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td className='text-center'>
                                    <a className='btn btn-mini-gray disabled'>Yes</a>
                                  </td>
                                </tr>
                                <tr>
                                  {/* <th>Heating </th> */}
                                  ...
                                  <td className='text-center'>
                                    <a className='btn btn-mini-gray disabled'>No</a>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td className='text-center'>
                                    <a className='btn btn-mini-gray disabled'>High</a>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td className='text-center border-bottom-0'>
                                    <p className='mb-0 text-muted fs-18 fw-500'>£180</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                    ...
                    <div className='car-payment text-center my-md-5 my-4'>
                      ...
                      <div className='active tab-pay'>
                        ...
                        <p className='fs-14'>
                          Amet minim mollit non deserunt ullamco est sit est aliqua dolor do amet sint. Velit officia
                          consequat e duis enim velit mollit. Exercitation veniam onequat sunt nostrud amet
                        </p>
                      </div>
                    ...
                    <div className='row'>
                      <div className='col-md-7 mx-auto'>
                        <Link to='/react/payment' className='btn btn-purple-radius w-100 mb-3'>
                          Accept
                        </Link>
                        <Link to='/react/customer' className='btn btn-purple-outline w-100 mb-3'>
                          Decline
                        </Link>
                      </div>
                    </div>
