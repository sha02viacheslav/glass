            ...
            <div className='col-md-8 mx-auto'>
              <div className='d-flex justify-content-between align-items-center mb-4 map-mob'>
                ...
                <div className='frame w-400'>
                  <h5 className='text-blue'>
                    August 25 2022{' '}
                    <a href='#'>
                      <span className='text-purple fs-14 fw-normal float-end'>EDIT BOOKING</span>
                    </a>
                  </h5>
                  <p className='mb-0 fs-14'>
                    Arriving between <span className='fw-500'> 02:00PM-04:00PM</span>{' '}
                  </p>
                </div>
              </div>
              ...
              <div className='text-center'>
                ...
                <a href='#' className='text-purple text-decoration-none'>
                  ...
                  >
                    <path
                      d='M11.4585 4.75H8.62516V0.25H4.37516V4.75H1.54183L6.50016 10.75L11.4585 4.75ZM0.833496 12.25H12.1668V13.75H0.833496V12.25Z'
                      fill='#9557E8'
                    />
                  </svg>
                  DOWNLOAD INVOICE
                ...
                <img
                  src={process.env.PUBLIC_URL + '/img/dot-line.svg'}
                ...
                <small className='fs-12'> 25 Aug 2022 - 06:28PM </small>
                <img
                  src={process.env.PUBLIC_URL + '/img/car-c.png'}
                  className='img-fluid my-3 d-block mx-auto'
                  alt=''
                />
              </div>
              ...
              <div className='row mt-5'>
                <div className='col-md-7 mx-auto'>
                  <a href='#' className='btn btn-purple-radius w-100 mb-3'>
                    Chat with us
                  </a>
                </div>
              </div>
