                  ...
                  <div className='col-md-4 '>
                    <div className='px-4'>
                      ...
                      <p>
                        ...
                        consequat duis enim velit mollit. Exercitatt sunt amet.
                      </p>
                      <ul className='list-unstyled list-price mb-4'>
                        <li>
                          <img src={process.env.PUBLIC_URL + '/img/check.svg'} className='img-fluid me-3' alt='' />
                          Lorem ipsum dolor sit
                        </li>
                        <li>
                          <img src={process.env.PUBLIC_URL + '/img/check.svg'} className='img-fluid me-3' alt='' />
                          Amet venim irure alue consectetur
                        </li>
                        <li>
                          <img src={process.env.PUBLIC_URL + '/img/check.svg'} className='img-fluid me-3' alt='' />
                          Anime euismod ullamco quis nostrud
                        </li>
                        <li>
                          <img src={process.env.PUBLIC_URL + '/img/check.svg'} className='img-fluid me-3' alt='' />
                          Consectetur sint exercitat mollit
                        </li>
                        <li>
                          <img src={process.env.PUBLIC_URL + '/img/check.svg'} className='img-fluid me-3' alt='' />
                          Duis aute deserunt velit
                        </li>
                      </ul>
                      <h5 className='text-blue text-center mb-4'>from $69 / month</h5>
                      <a href='#' className='btn btn-et w-100'>
                        Choose the Plan
                      </a>
                    </div>
                  </div>
