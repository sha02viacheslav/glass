  ...
  return (
    <Box className='container'>
      <Box sx={{ py: { xs: 40, lg: 65 }, maxWidth: 780 }}>
        ...
        <Box sx={{ fontSize: { xs: 16, lg: 20 }, lineHeight: '24px' }} className='text-gray-700'>
          <Box sx={{ mb: { xs: 4, lg: 8 } }}>
            Welcome to FixGlass website. By accessing this website, you agree to comply with and be bound by the
          ...
          <List sx={{ mb: 6, listStyle: 'auto', pl: 4 }} component='ol'>
            ...
            <ListItem>
              <b>Service Information:</b> We strive to provide accurate and up-to-date information regarding our car
              glass repair services. However, we do not guarantee the completeness, accuracy, reliability, or
              suitability of the information and materials found on this website.
            </ListItem>
            <ListItem>
              <b>Booking and Payments:</b> Booking services through our website is subject to availability. Payment
              terms and conditions will be provided during the booking process.
            </ListItem>
            <ListItem>
              <b>Cancellation and Refunds:</b> Cancellation and refund policies vary based on the type of service
              booked. Please refer to our specific cancellation and refund policy for more information.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              ...
              for your convenience to provide further information. We have no responsibility for the content of the
              linked websites.
            </ListItem>
            <ListItem>
          ...
          <Box sx={{ mb: 6, fontSize: { xs: 16, lg: 20 } }}>
